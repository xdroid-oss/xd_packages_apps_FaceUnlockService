...
public class FaceUnlockEncryptorDependencyLib {
    public static final String AKS_PROVIDER = "AndroidKeyStore";
    private static final int PROFILE_KEY_IV_SIZE = 12;
    public static final String SEED_ALIAS = "seed_faceunlock";
    private static final String TAG = FaceUnlockEncryptorDependencyLib.class.getSimpleName();

    public FaceUnlockEncryptorDependencyLib() {
        saveSeed();
    }
